    ...
    api.get("/content/ai/history/")
      .then((res) => {
        ...
        if (history.length > 0) {
          ...
          setMessages([{
            role: "assistant",
            content: "Hi! I'm your Odoo learning assistant. Ask me about any topic, lesson, or Odoo feature and I'll point you in the right direction.",
      ...
      .catch(() => {
        setMessages([{
          role: "assistant",
          content: "Hi! I'm your Odoo learning assistant. Ask me about any topic, lesson, or Odoo feature.",
          timestamp: new Date().toISOString(),
        }]);
      })
  ...
  const send = async () => {
    ...
    try {
      ...
      api.post("/content/ai/history/save/", {
        messages: finalMessages.slice(-20).map(({ role, content, timestamp }) => ({ role, content, timestamp })),
      }).catch(() => {});
    } catch {
      setMessages([...newMessages, {
        role: "assistant",
    ...
    <div style={{ position: "fixed", bottom: "24px", right: "24px", zIndex: 9999 }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: "6px" }}>
              <button
                ...
                style={{
                  fontSize: "11px", color: "#9ca3af", background: "none", border: "none",
              ...
              <button onClick={() => setOpen(false)}
                style={{ fontSize: "18px", color: "#9ca3af", background: "none", border: "none", cursor: "pointer", lineHeight: 1 }}>
                ×
              </button>
            </div>
          </div>
          ...
          <div style={{ flex: 1, overflowY: "auto", padding: "12px 14px", display: "flex", flexDirection: "column", gap: "10px" }}>
            ...
            {!historyLoaded && (
              <div style={{ display: "flex", justifyContent: "center", padding: "20px 0" }}>
                <div style={{ width: "20px", height: "20px", border: "2px solid #e5e7eb", borderTopColor: PURPLE, borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
              </div>
            )}
            ...
            {messages.map((msg, i) => (
              <div key={i}>
                ...
                {msg.timestamp && (
                  <div style={{
                    fontSize: "10px", color: "#9ca3af", marginTop: "2px",
          ...
          <div style={{ padding: "10px 12px", borderTop: "1px solid #f3f4f6", display: "flex", gap: "8px", flexShrink: 0 }}>
            <input
              ...
              style={{
                flex: 1, fontSize: "12.5px", border: "1px solid #e5e7eb",
                borderRadius: "10px", padding: "8px 12px", outline: "none", background: "#f9fafb",
              }}
            />
      ...
      <button
        ...
        style={{
          ...
          display: "flex", alignItems: "center", justifyContent: "center",
          boxShadow: "0 4px 16px rgba(113,75,103,0.4)", fontSize: "20px",
